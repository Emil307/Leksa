...
2. Start backend through named skill execution: `run-backend`
3. Run ONLY the target scenario group through named skill execution: `test-acceptance backend {TestName}`
4. Check results:
   - ALL pass -- done
...
5. Stop backend through named skill execution: `stop-backend`
