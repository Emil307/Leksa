...
the matching three-stage backend-style, frontend, or bot sequence wherever its tier
puts it.
...
## Tier 1 — Bot Scenarios (07_Bot_Tests.md)

### 1.1 The bot completes the user flow
...
Bot sections use the staged bot shape shown above. Stage 2 joins bot-logic,
bot-API, and handler lanes; Stage 3 owns isolated bot E2E verification and review.
