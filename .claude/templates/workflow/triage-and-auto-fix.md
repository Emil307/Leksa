...
no recommended option or no one-plain-sentence question, batch the rest into **one** structured user-decision request (or one direct question when structured input is unavailable) in
