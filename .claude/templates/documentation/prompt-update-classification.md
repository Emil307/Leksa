...
**Input:** "Move component-specific selectors out of the theme stylesheet into the component as utilities"
**Classification:**
...
- Step-by-step how-to with code examples → new `templates/refactoring/colocate-component-styles.md`
