...
## Bot Scenario Sequence

For each scenario in `tests/07_Bot_Tests.md`, use
`.claude/templates/workflow/parallel-bot-stages.md`. Preserve any custom bot plan
whose execution already started.
